  ...
  const philosophyItems: PhilosophyItem[] = [
    {
      ...
      description: "I believe in transforming manual processes into intelligent, self-healing systems that anticipate problems before they occur.",
      color: "text-accent"
    },
    {
      icon: "ShieldCheckIcon",
      title: "Reliability as Foundation",
      description: "Zero downtime isn't luck—it's engineering. Every system I design prioritizes bulletproof reliability and graceful failure handling.",
      color: "text-success"
    },
    {
      icon: "ChartBarIcon",
      title: "Cost-Conscious Excellence",
      description: "Optimization isn't just about performance—it's about delivering maximum value while minimizing resource waste and operational costs.",
      color: "text-warning"
    },
    {
      icon: "UsersIcon",
      title: "Collaborative Leadership",
      description: "The best infrastructure solutions emerge from cross-functional collaboration, knowledge sharing, and empowering team growth.",
      color: "text-primary"
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            >
              ...
              <div className="mb-6">
                <div className="w-16 h-16 bg-gradient-to-br from-card to-muted rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                  <Icon name={item.icon as any} size={28} className={`${item.color} group-hover:drop-shadow-lg`} />
                </div>
              </div>
        ...
        <div className="mt-20 text-center">
          <div className="max-w-4xl mx-auto p-8 lg:p-12 glass-card rounded-3xl border border-accent/20">
            <Icon name="ChatBubbleLeftRightIcon" size={48} className="text-accent mx-auto mb-6 opacity-60" />
            
            <blockquote className="text-2xl lg:text-3xl font-light text-foreground leading-relaxed mb-6">
              "I don't just maintain infrastructure—I revolutionize it. Every challenge is an opportunity 
              to create something more elegant, more efficient, and more reliable than before."
            </blockquote>
