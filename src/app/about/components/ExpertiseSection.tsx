  ...
  const expertiseAreas: ExpertiseArea[] = [
    {
      ...
      description: "Designing and implementing scalable cloud solutions across AWS, Azure, and GCP with focus on cost optimization and performance.",
    ...
    },
    {
      ...
      description: "Building robust deployment pipelines that ensure fast, reliable, and secure software delivery with automated testing and monitoring.",
    ...
    },
    {
      ...
      description: "Orchestrating containerized applications at scale using Kubernetes, Docker, and service mesh technologies for high availability.",
    ...
    },
    {
      ...
      description: "Implementing security-first DevOps practices with automated compliance, vulnerability scanning, and secure deployment strategies.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed">
            Deep expertise across the entire DevOps ecosystem, from cloud architecture 
            to security implementation, with proven results in enterprise environments.
          </p>
        </div>
          ...
          {expertiseAreas.map((area, index) => (
            ...
            >
              ...
              <div className="flex items-start space-x-4 mb-6">
                <div className={`w-16 h-16 rounded-2xl flex items-center justify-center border ${getColorClasses(area.color)} group-hover:scale-110 transition-transform duration-300`}>
              ...
              {/* Skills */}
              <div className="mb-6">
                <h4 className="text-sm font-semibold text-card-foreground mb-3">Key Technologies</h4>
