...
const HeroSection = ({ className = '' }: HeroSectionProps) => {
  return (
    ...
    <section className={`relative min-h-screen-safe flex justify-center overflow-hidden pt-32 lg:pt-24 ${className}`}>
      {/* Background Effects */}
          ...
          <div className="text-center lg:text-left space-y-8">
            ...
            <div className="space-y-6">
              <p className="text-lg text-card-foreground leading-relaxed">
                I embody the perfect fusion of technical mastery and innovative problem-solving in the DevOps realm. 
                My expertise lies at the intersection of cost optimization, zero-downtime reliability, and automation excellence.
              </p>
              {/* Key Metrics */}
